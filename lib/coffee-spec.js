(function(){
  var CoffeeScript, _CoffeeScript, add_error, assert, child_process, cleanup_stack, compile_and_run_file, current_describe, debug, describe, errors, failed, fs, global_scope, helpers, init, it, path, print_file, puts, report, run_file, run_standalone, run_tests, start_time, succeeded, summarize, sys, term, test_exports, tests, unit;
