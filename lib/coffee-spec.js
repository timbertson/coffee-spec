(function(){
  ...
  exports.report = (report = function report(verbose) {
  ...
  exports.summarize = (summarize = function summarize() {
  ...
  exports.run_standalone = (run_standalone = function run_standalone(verbose) {
    run_tests(verbose);
    report(verbose);
    return process.exit(failed);
  });
  // Add tests from a file and immediately run them
  exports.run_file = (run_file = function run_file(file, verbose) {
    var code;
    if (verbose) {
      print_file(file);
    }
  ...
  exports.compile_and_run_file = (compile_and_run_file = function compile_and_run_file(dir, file, temp_path, verbose, cb) {
  ...
  exports.run = function run(dir, options) {
